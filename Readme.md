# ⚠ This repo is no longer maintained by the original creator - 40 Cakes. See their latest version of the bot here - check out: [PokéBot Gen3 for mGBA](https://github.com/40Cakes/pokebot-gen3) instead! ⚠
